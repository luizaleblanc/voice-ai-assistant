    ...
    <div className="flex flex-col items-center justify-center space-y-6">
      ...
      <div className="relative">
        {!isRecording ? (
          ...
          >
            <div className="w-20 h-20 bg-slate-700 hover:bg-slate-800 rounded-full flex items-center justify-center shadow-lg hover:shadow-slate-300 transition-all transform group-active:scale-95">
          ...
          <button
            ...
            title="Finalizar"
          >
            <div className="w-20 h-20 bg-white border-4 border-slate-600 rounded-full flex items-center justify-center hover:bg-slate-50 transition-all transform group-active:scale-95 shadow-lg">
              <Square className="w-8 h-8 text-slate-700 fill-current" />
            </div>
            <span className="text-sm font-semibold text-slate-600 group-hover:text-slate-800">
              Parar
            </span>
